 ...
 * @brief TTN functions
 * 
 * These functions enables ESP32 devices with SX1272/73/76/77/78/79 LoRaWAN chips
 * to communicate via The Things Network.
 */

/**
 * @brief Initialize the TTN structures.
 * 
 * Must be called before using any other functions, but only once.
 */
void ttn_init();
